...
| 项目               | 描述           | 链接                                                    |
|------------------|--------------|-------------------------------------------------------|
| frontend      | PPanel 前端  | [GitHub](https://github.com/perfect-panel/frontend) |
| backend  | PPanel 后端  | [GitHub](https://github.com/perfect-panel/backend)                         |
| ppanel-node  | PPanel 节点端  | [GitHub](https://github.com/perfect-panel/ppanel-node)                         |
## 🌐 官方网站
